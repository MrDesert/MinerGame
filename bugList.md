...
|5|23.01.26|Не всегда происходит сохранение в LocalStorage в основном на мобильных устройствах|-|🔴⚠️|🟥🔥|Предположитель при засыпании страницы браузер удалет всё то что не сохранено, а при покидании страницы сохранние не реализовано|🏃⚡|🧪📝|
|6|23.01.26||||||||
## Закрытые баги
